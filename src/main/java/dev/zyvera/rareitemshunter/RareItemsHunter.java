...
public final class RareItemsHunter extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (cmd != null) { cmd.setExecutor(riCmd); cmd.setTabCompleter(riCmd); }
    ...
    public void setGuiPage(UUID uuid, int page) { openGuiPages.put(uuid, page); }
    public int getGuiPage(UUID uuid) { return openGuiPages.getOrDefault(uuid, -1); }
    public void clearGuiPage(UUID uuid) { openGuiPages.remove(uuid); }
    public boolean hasGuiOpen(Player player) { return openGuiPages.containsKey(player.getUniqueId()); }
    ...
    public boolean isNavigationLocked(UUID uuid) { return navLock.contains(uuid); }

    public RareItemManager getRareItemManager() { return rareItemManager; }
    public PlayerDataManager getPlayerDataManager() { return playerDataManager; }
    public RareItemsGUI getGui() { return gui; }
