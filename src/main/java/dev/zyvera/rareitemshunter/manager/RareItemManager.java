...
public class RareItemManager {
    ...
    // { id, Material, displayName, rarityRank, shortChance, shortDescription, occurrenceOnly }
    private static final Object[][] DEFAULTS = {
        ...
        { "endportal_12_eye", Material.ENDER_EYE,
          ...
          "Alle 12 Rahmen natürlich befüllt", true },
        ...
        { "music_disc_5", Material.MUSIC_DISC_5,
          ...
          "9 Fragmente aus Alte-Stadt-Truhen", false },
        ...
        { "music_disc_11", Material.MUSIC_DISC_11,
          ...
          "Creeper muss von einem Skelett getötet werden", false },
        ...
        { "heavy_core", Material.HEAVY_CORE,
          ...
          "Unheilvoller Tresor (Prüfungskammer)", false },
        ...
        { "elytra", Material.ELYTRA,
          ...
          "Endstadtschiff nach dem Enderdrachen-Sieg", false },

        { "rabbit_foot", Material.RABBIT_FOOT,
          "&e&lHasenpfote", 26, "~10 %",
          "Drop bei Hasen (mit Plünderung höher)", false },
        ...
        { "charged_creeper", Material.GUNPOWDER,
          ...
          "Blitz trifft Creeper in 4-Block-Nähe", true },

        { "cactus_5high", Material.CACTUS,
          "&2&lKaktus 5 Blöcke hoch", 33, "~0.003 %",
          "Benötigt 2 zusätzliche Wachstumszyklen", false },
    };
